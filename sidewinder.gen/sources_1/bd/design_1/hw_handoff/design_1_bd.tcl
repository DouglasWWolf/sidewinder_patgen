...
# module references:
# axi_revision, data_sink, axis_output_sel, data_consumer, data_consumer, axi_qsfp_status, simframe_ctl, simframe_gen, eth_reset_mgr, eth_reset_mgr
...
# Hierarchical cell: simframe
proc create_hier_cell_simframe { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_simframe() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: simframe_ila, and set properties
  set simframe_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 simframe_ila ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins AXIS_OUT] [get_bd_intf_pins simframe_gen/AXIS_OUT]
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn1] [get_bd_intf_pins AXIS_OUT] [get_bd_intf_pins simframe_ila/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI] [get_bd_intf_pins simframe_ctl/S_AXI]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets simframe_ctl_AXIS_OUT] [get_bd_intf_pins simframe_gen/AXIS_IN] [get_bd_intf_pins simframe_ila/SLOT_0_AXIS]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins simframe_ctl/clk] [get_bd_pins simframe_gen/clk] [get_bd_pins simframe_ila/clk]
  connect_bd_net -net resetn_1 [get_bd_pins resetn] [get_bd_pins simframe_ctl/resetn] [get_bd_pins simframe_gen/resetn] [get_bd_pins simframe_ila/resetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: output_select, and set properties
  set block_name axis_output_sel
  set block_cell_name output_select
  if { [catch {set output_select [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $output_select eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: simframe
  create_hier_cell_simframe [current_bd_instance .] simframe
  ...
  connect_bd_intf_net -intf_net axis_output_sel_0_AXIS_TX0 [get_bd_intf_pins data_sink/AXIS_RX] [get_bd_intf_pins output_select/AXIS_TX0]
  connect_bd_intf_net -intf_net axis_output_sel_0_AXIS_TX1 [get_bd_intf_pins output_select/AXIS_TX1] [get_bd_intf_pins qsfp_data/QSFP_TX0_STREAM]
  ...
  connect_bd_intf_net -intf_net simframe_AXIS_OUT [get_bd_intf_pins output_select/AXIS_RX] [get_bd_intf_pins simframe/AXIS_OUT]
  ...
  connect_bd_intf_net -intf_net system_interconnect_M03_AXI [get_bd_intf_pins output_select/S_AXI] [get_bd_intf_pins system_interconnect/M03_AXI]
  ...
  connect_bd_intf_net -intf_net system_interconnect_M06_AXI [get_bd_intf_pins simframe/S_AXI] [get_bd_intf_pins system_interconnect/M06_AXI]

  # Create port connections
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports pb_rst_n] [get_bd_pins system_reset_100mhz/ext_reset_in]
  connect_bd_net -net ila_250mhz [get_bd_pins axi_revision/AXI_ACLK] [get_bd_pins data_sink/clk] [get_bd_pins output_select/clk] [get_bd_pins pcie_axi_bridge/axi_aclk] [get_bd_pins qsfp_data/data_clock] [get_bd_pins simframe/clk] [get_bd_pins system_interconnect/aclk]
  ...
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins axi_revision/AXI_ARESETN] [get_bd_pins data_sink/resetn] [get_bd_pins output_select/resetn] [get_bd_pins pcie_axi_bridge/axi_aresetn] [get_bd_pins qsfp_data/data_aresetn] [get_bd_pins simframe/resetn]
  ...
  assign_bd_address -offset 0x00000700 -range 0x00000100 -target_address_space [get_bd_addr_spaces pcie_axi_bridge/pcie_bridge/M_AXI_B] [get_bd_addr_segs output_select/S_AXI/reg0] -force
  ...
  assign_bd_address -offset 0x00000600 -range 0x00000100 -target_address_space [get_bd_addr_spaces pcie_axi_bridge/pcie_bridge/M_AXI_B] [get_bd_addr_segs simframe/simframe_ctl/S_AXI/reg0] -force
